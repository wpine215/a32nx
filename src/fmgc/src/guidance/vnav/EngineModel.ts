...
export class EngineModel {
     ...
     */
    static maxClimbThrustTable1133 = [
        ...
        [-54.0, 72.1, 73.6, 74.9, 76.5, 78.1, 78.9, 80.2, 81.9, 82.2, 82.8, 83.7, 83.9, 83.6],
        [-50.0, 72.8, 74.3, 75.5, 77.2, 78.8, 79.6, 80.9, 82.7, 82.9, 83.6, 84.5, 84.7, 84.4],
        [-46.0, 73.4, 74.9, 76.2, 77.9, 79.5, 80.3, 81.6, 83.4, 83.7, 84.3, 85.2, 85.4, 85.1],
        [-42.0, 74.1, 75.6, 76.9, 78.5, 80.2, 81.0, 82.3, 84.2, 84.4, 85.0, 86.0, 86.1, 85.8],
        [-38.0, 74.7, 76.2, 77.5, 79.2, 80.8, 81.7, 83.0, 84.9, 85.0, 85.7, 86.7, 86.8, 86.5],
        [-34.0, 75.3, 76.8, 78.1, 79.8, 81.5, 82.4, 83.7, 85.6, 85.7, 86.4, 87.4, 87.5, 87.2],
        [-30.0, 75.9, 77.5, 78.8, 80.5, 82.2, 83.0, 84.4, 86.2, 86.4, 87.1, 88.1, 88.2, 87.9],
        [-26.0, 76.5, 78.1, 79.4, 81.1, 82.8, 83.7, 85.0, 86.9, 87.1, 87.8, 88.8, 88.9, 88.6],
        [-22.0, 77.1, 78.7, 80.0, 81.8, 83.5, 84.4, 85.7, 87.6, 87.8, 88.5, 89.5, 89.6, 89.3],
        [-18.0, 77.7, 79.3, 80.7, 82.4, 84.1, 85.0, 86.4, 88.2, 88.5, 89.2, 90.2, 90.0, 89.7],
        [-14.0, 78.3, 79.9, 81.3, 83.0, 84.8, 85.7, 87.0, 88.9, 89.1, 89.8, 90.1, 89.6, 89.3],
        [-10.0, 78.9, 80.5, 81.9, 83.7, 85.4, 86.3, 87.7, 89.6, 89.8, 90.5, 89.7, 89.1, 88.7],
        [-6.0, 79.5, 81.2, 82.5, 84.3, 86.0, 86.9, 88.3, 90.2, 90.4, 90.7, 89.2, 88.5, 88.2],
        [-2.0, 80.1, 81.8, 83.1, 84.9, 86.7, 87.6, 88.9, 90.9, 91.1, 90.3, 88.7, 88.0, 87.6],
        [2.0, 80.7, 82.4, 83.8, 85.5, 87.3, 88.2, 89.5, 91.2, 90.8, 89.8, 88.1, 87.3, 86.9],
        [6.0, 81.3, 83.0, 84.4, 86.2, 87.9, 88.8, 90.1, 90.8, 90.4, 89.3, 87.4, 86.5, 86.1],
        [10.0, 81.9, 83.6, 85.0, 86.8, 88.6, 89.4, 90.0, 90.4, 90.0, 88.7, 86.7, 85.7, 85.2],
        [14.0, 82.5, 84.2, 85.6, 87.4, 89.2, 89.2, 89.5, 89.8, 89.4, 88.0, 85.9, 84.8, 84.1],
        [18.0, 83.1, 84.8, 86.2, 88.0, 88.7, 88.7, 88.9, 89.2, 88.7, 87.3],
        [22.0, 83.7, 85.4, 86.1, 87.5, 88.1, 88.2, 88.3, 88.6, 88.1, 86.5],
        [26.0, 84.3, 85.6, 85.5, 86.9, 87.6, 87.5, 87.7, 87.9, 87.3, 85.6],
        [30.0, 84.8, 84.7, 84.7, 86.2, 86.9, 86.8, 86.9, 87.2, 86.5],
        [34.0, 84.1, 83.9, 83.9, 85.5, 86.1, 86.0, 86.1, 86.4],
        [38.0, 83.4, 83.2, 83.1, 84.7, 85.3, 85.3, 85.5],
        [42.0, 82.7, 82.4, 82.3, 84.0, 84.6, 84.6],
        [46.0, 81.9, 81.7, 81.6, 83.4, 84.0],
    ];

    static maxClimbThrustTable1127 = [
        [0, 2000, 5000, 8000, 12000, 15000, 17000, 20000, 25000, 27000, 31000, 35000, 39000, 41000],
        [-54.0, 72.1, 73.6, 74.9, 76.5, 78.1, 78.9, 80.2, 81.9, 82.2, 82.8, 83.7, 83.9, 83.6],
        [-50.0, 72.8, 74.3, 75.5, 77.2, 78.8, 79.6, 80.9, 82.7, 82.9, 83.6, 84.5, 84.7, 84.4],
        [-46.0, 73.4, 74.9, 76.2, 77.9, 79.5, 80.3, 81.6, 83.4, 83.7, 84.3, 85.2, 85.4, 85.1],
    ...
    static maxTakeoffThrustTable1127 = [
        [0, -2000, -1000, 0, 1000, 2000, 3000, 4000, 5000, 6000, 7000],
        [-55.0, 68.9, 70.0, 71.1, 72.1, 73.1, 74.1, 75.2, 76.2, 77.3, 78.3],
        [-50.0, 69.7, 70.8, 71.9, 72.9, 73.9, 74.9, 76.0, 77.1, 78.1, 79.2],
        [-40.0, 71.2, 72.3, 73.4, 74.5, 75.5, 76.5, 77.7, 78.8, 79.8, 80.9],
        [-30.0, 72.7, 73.8, 75.0, 76.0, 77.1, 78.1, 79.3, 80.4, 81.5, 82.6],
        [-20.0, 74.2, 75.3, 76.5, 77.6, 78.6, 79.7, 80.9, 82.0, 83.1, 84.2],
        [-10.0, 75.6, 76.8, 78.0, 79.1, 80.2, 81.3, 82.5, 83.6, 84.7, 85.9],
        [-5.0, 76.4, 77.5, 78.7, 79.8, 80.9, 82.0, 83.2, 84.4, 85.5, 86.7],
        [0.0, 77.1, 78.3, 79.5, 80.6, 81.7, 82.8, 84.0, 85.2, 86.4, 87.5],
        [2.0, 77.4, 78.6, 79.8, 80.9, 82.0, 83.1, 84.3, 85.6, 86.7, 87.9],
        [5.0, 77.8, 79.0, 80.2, 81.3, 82.5, 83.6, 84.8, 86.1, 87.2, 88.3],
        [8.0, 78.2, 79.4, 80.7, 81.8, 82.9, 84.1, 85.3, 86.5, 87.7, 88.8],
        [10.0, 78.5, 79.7, 81.0, 82.1, 83.2, 84.4, 85.6, 86.9, 88.0, 89.2],
        [12.0, 78.8, 80.0, 81.3, 82.4, 83.5, 84.7, 85.9, 87.2, 88.3, 89.5],
        [14.0, 79.1, 80.3, 81.6, 82.7, 83.8, 85.0, 86.3, 87.5, 88.6, 89.8],
        [16.0, 79.4, 80.6, 81.9, 83.0, 84.1, 85.3, 86.6, 87.8, 89.0, 90.2],
        [18.0, 79.7, 80.9, 82.2, 83.3, 84.5, 85.6, 86.9, 88.1, 89.3, 90.5],
        [20.0, 80.0, 81.2, 82.5, 83.6, 84.8, 85.9, 87.2, 88.5, 89.6, 90.8],
        [22.0, 80.3, 81.5, 82.8, 83.9, 85.1, 86.3, 87.5, 88.8, 89.9, 90.8],
        [24.0, 80.6, 81.8, 83.1, 84.2, 85.4, 86.6, 87.8, 89.1, 90.3, 90.5],
        [26.0, 80.9, 82.1, 83.4, 84.5, 85.7, 86.9, 88.1, 89.4, 90.6, 90.2],
        [28.0, 81.1, 82.4, 83.7, 84.8, 86.0, 87.2, 88.4, 89.7, 90.3, 89.8],
        [30.0, 81.4, 82.7, 83.9, 85.1, 86.3, 87.5, 88.8, 90.0, 90.0, 89.5],
        [32.0, 81.7, 83.0, 84.2, 85.4, 86.6, 87.8, 89.1, 90.1, 89.6, 89.1],
        [34.0, 82.0, 83.3, 84.5, 85.7, 86.9, 88.1, 89.4, 89.8, 89.3, 88.8],
        [36.0, 82.3, 83.6, 84.8, 86.0, 87.2, 88.4, 89.4, 89.4, 88.9, 88.4]
    ];
