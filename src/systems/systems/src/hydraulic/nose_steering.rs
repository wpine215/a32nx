...
impl SteeringAngleLimiter {
    pub fn new(speed_map: [f64; 5], speed_coeff_map: [f64; 5]) -> SteeringAngleLimiter {
...
mod tests {
    ...
    fn pedal_speed_angle_limiter() -> SteeringAngleLimiter {
    ...
    fn tiller_speed_angle_limiter() -> SteeringAngleLimiter {
